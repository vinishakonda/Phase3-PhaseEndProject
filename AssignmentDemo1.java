...
public class AssignmentDemo2 {
	...
	Logger logger = LogManager.getLogger(AssignmentDemo2.class);

	@Test(priority = '1')
	public void assignment002Post() {
		logger.info("Course End project - Assignment002 - POST request");
		File file = new File(
				"C:\\Users\\farha\\eclipse-workspace\\Rest-API\\Phase-3-rest-API\\scr\\main\\resource\\data.json");
	...
	public void assignment002Put() {
		File file = new File(
				"C:\\Users\\farha\\eclipse-workspace\\Rest-API\\Phase-3-rest-API\\scr\\main\\resource\\dataput.json");
		int id = RestAssured.given().baseUri("https://petstore.swagger.io/v2/pet/").contentType(ContentType.JSON)
